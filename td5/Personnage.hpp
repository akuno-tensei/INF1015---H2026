/*
		...
		Description : Ce fichier contient la définition de la classe Personnage, 
					  qui représente un personnage dans un jeu vidéo.  
					  La classe hérite de la classe Affichable et 
					  ajoute des attributs tels que le nom du personnage et le jeu de parution.  
					  Elle implémente les méthodes d'affichage et 
					  de changement de couleur pour personnaliser l'apparence du personnage lors de l'affichage.
*/
